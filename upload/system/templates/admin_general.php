										...
										<form method="post" action="">
											<table id="setform" cellspacing="5">
												...
												<tr>
													...
													<td>
														<label style="width:80px; float:left; clear:none;"><input type="checkbox" name="atch_link" value="1" <?= $D->post_atch_link?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_patlinks') ?></span></label>
														<label style="width:80px; float:left; clear:none;"><input type="checkbox" name="atch_image" value="1" <?= $D->post_atch_image?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_patimages') ?></span></label>
														<label style="width:80px; float:left; clear:both;"><input type="checkbox" name="atch_video" value="1" <?= $D->post_atch_video?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_patvideos') ?></span></label>
														<label style="width:80px; float:left; clear:none;"><input type="checkbox" name="atch_file" value="1" <?= $D->post_atch_file?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_patfiles') ?></span></label>
													</td>
												</tr>
												<tr>
